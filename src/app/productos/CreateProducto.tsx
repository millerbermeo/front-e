...
import {ProductFormData, productSchema} from "../../shemas/product.shema";
...
const CreateProducto: React.FC = () => {
    ...
    const handleRegisterProduct: SubmitHandler<ProductFormData> = (data) => {
    ...
    return (
        <>
            ...
            <form className='w-full container mx-auto my-10 flex  justify-center items-start gap-10'
                  onSubmit={handleSubmit(handleRegisterProduct)} encType="multipart/form-data">
